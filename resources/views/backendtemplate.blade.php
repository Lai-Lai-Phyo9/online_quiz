  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('subjects.index') }}">
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item" >
          <a class="nav-link collapsed" href="{{ route('topics.index') }}">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="{{ route('questions.index') }}" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{ route('questions.index') }}">QuestionType</a>
              <a class="collapse-item" href="{{ route('multiquestions.index') }}">MultipleChoice</a>
              <a class="collapse-item" href="{{ route('truefalsequestions.index') }}">TrueFalse</a>
              <a class="collapse-item" href="{{ route('shortquestions.index') }}">ShortQuestion</a>
            </div>
          </div>
        </li>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Online Quiz 2020</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
