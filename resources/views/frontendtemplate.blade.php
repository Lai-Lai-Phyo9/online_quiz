...
<html lang="en">
  ...
  <title>Online Quiz @yield('title')</title>
    ...
    <link rel="stylesheet" href="{{asset('frontendtemplate/css/themify-icons.css')}}" />
    <link rel="stylesheet" href="{{asset('frontendtemplate/vendors/owl-carousel/owl.carousel.min.css')}}" />
    <link rel="stylesheet" href="{{asset('frontendtemplate/vendors/nice-select/css/nice-select.css')}}" />
    <!-- main css -->
...
{{--                 <li class="nav-item submenu dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="{{ route('show') }}">Courses</a>
                    </li>
                    <li class="nav-item">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="{{asset('frontendtemplate/js/popper.js')}}"></script>
    <script src="{{asset('frontendtemplate/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('frontendtemplate/vendors/nice-select/js/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('frontendtemplate/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('frontendtemplate/js/owl-carousel-thumb.min.js')}}"></script>
